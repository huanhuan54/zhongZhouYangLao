...
let paperRankHandlers = {
        swufe: doswufePaperRank,
        Title: doTitlePaperRank,
        ahci: doahciPaperRank,
        ajg: doajgPaperRank,
        ccf: doccfPaperRank,
        cqu: docquPaperRank,
        cscd: docscdPaperRank,
        cssci: docssciPaperRank,
        cufe: docufePaperRank,
        cug: docugPaperRank,
        eii: doeiiPaperRank,
        fdu: dofduPaperRank,
        hhu: dohhuPaperRank,
        ...
        ruc: dorucPaperRank,
        sci: dosciPaperRank,
        sciif: dosciifPaperRank,
        jci: dojciPaperRank,
        sciif5: dosciif5PaperRank,
        sciBase: dosciBasePaperRank,
        sciUp: dosciUpPaperRank,
        sdufe: dosdufePaperRank,
        sjtu: dosjtuPaperRank,
        ssci: dossciPaperRank,
        swjtu: doswjtuPaperRank,
        uibe: douibePaperRank,
        xju: doxjuPaperRank,
        xmu: doxmuPaperRank,
        xdu: doxduPaperRank,
        zhongguokejihexin: dozhongguokejihexinPaperRank,
        fms: dofmsPaperRank,
        scu: doscuPaperRank,
        sciwarn: dosciwarnPaperRank,
        zju: dozjuPaperRank,
        cju: docjuPaperRank,
        ft50: doft50PaperRank,
        utd24: doutd24PaperRank,
        zhintro: dozhintroPaperRank,
        enintro: doenintroPaperRank,
        esi: doesiPaperRank,
        cpu: docpuPaperRank,
        sciUpTop: dosciUpTopPaperRank,

        xrWarn: doxrWarnPaperRank,
        esci: doesciPaperRank,
        xr: doxrPaperRank,
        xrTop: doxrTopPaperRank,

        Custom: doCustomPaperRank
    }
;


let paperNameHandlers = {
        Baidu: getBaiduPaperNames,
        BaiduDetail: getBaiduDetailPaperNames,
        BaiduOld: getBaiduOldPaperNames,
        Aminer: getAminerPaperNames,
        AminerDetail: getAminerDetailPaperNames,
        Dblp: getDblpPaperNames,
        Ieee: getIeeePaperNames,
        IeeeDetail: getIeeeDetailPaperNames,
        Google: getGooglePaperNames,
        GoogleCitations: getGoogleCitationsPaperNames,
        WOSDetail: getWOSDetailPaperNames,
        WOS: getWOSPaperNames,
        WOSJCR: getWOSJCRPaperNames,
        WOSJCRDetail: getWOSJCRDetailPaperNames,
        Pubmed: getPubmedPaperNames,
        PubmedDetail: getPubmedDetailPaperNames,
        ReadPaper: getReadPaperPaperNames,
        ReadPaperDetail: getReadPaperDetailPaperNames,
        ScienceDirect: getScienceDirectPaperNames,
        ScienceDirectDetail: getScienceDirectDetailPaperNames,
        Springer: getSpringerPaperNames,
        Springeropen: getSpringeropenPaperNames,
        SpringerDetail: getSpringerDetailPaperNames,
        YuntsgDetail: getYuntsgDetailPaperNames,
        YuntsgPubmedDetail: getYuntsgPubmedDetailPaperNames,
        YuntsgXueshu: getYuntsgXueshuPaperNames,
        Yuntsgen: getYuntsgenPaperNames,
        Yuntsgcn: getYuntsgcnPaperNames,
        YuntsgPubmed: getYuntsgPubmedPaperNames,
        CnkiClassic: getCnkiClassicPaperNames,
        CnkiSentence: getCnkiSentencePaperNames,
        CnkiDetail: getCnkiDetailPaperNames,
        Embase: getEmbasePaperNames,
        EmbaseDetail: getEmbaseDetailPaperNames,
        Scopus: getScopusPaperNames,
        ScopusDetail: getScopusDetailPaperNames,
        Huayi: getHuayiPaperNames,
        XMOL: getXMOLPaperNames,
        XMOLDetail: getXMOLDetailPaperNames,
        XMOLSquare: getXMOLSquarePaperNames,
        ScopusAuthor: getScopusAuthorPaperNames,
        Wangfang: getWangfangPaperNames,
        WangfangDetail: getWangfangDetailPaperNames,
        WOSSelect: getWOSSelectPaperNames,
        SpringerSelect: getSpringerSelectPaperNames,
        SpringerSelectDetail: getSpringerSelectDetailPaperNames,
        JournalFinder: getJournalFinderPaperNames,
        CnkiSpace: getCnkiSpacePaperNames,
        Weipu: getWeipuPaperNames,
        WeipuDetail: getWeipuDetailPaperNames,
        Semantic: getSemanticPaperNames,
        SemanticDetail: getSemanticDetailPaperNames,
        OldCnki: getOldCnkiPaperNames,
        ResearchGate: getResearchGatePaperNames,
        CnkiAuthor: getCnkiAuthorPaperNames,
        Jstor: getJstorPaperNames,
        Ei: getEiPaperNames,
        EiDetail: getEiDetailPaperNames,
        Duke: getDukePaperNames,
        Wiley: getWileyPaperNames,
        NudtChaoxing: getNudtChaoxingPaperNames,
        NudtChaoxingDetail: getNudtChaoxingDetailPaperNames,
        Nssd: getNssdPaperNames,
        NssdDetail: getNssdDetailPaperNames,
        Proquest: getProquestPaperNames,
        ProquestDetail: getProquestDetailPaperNames,
        Cambridge: getCambridgePaperNames,
        CambridgeDetail: getCambridgeDetailPaperNames,
        Oxford: getOxfordPaperNames,
        OxfordDetail: getOxfordDetailPaperNames,
        Edinburge: getEdinburgePaperNames,
        EdinburgeDetail: getEdinburgeDetailPaperNames,
        Duxiu: getDuxiuPaperNames,
        Duxiu2: getDuxiu2PaperNames,
        CnkiScholar: getCnkiScholarPaperNames,
        CnkiScholarDetail: getCnkiScholarDetailPaperNames,
        ConnectedPapers: getConnectedPapersPaperNames,
        ConnectedPapersDetail: getConnectedPapersDetailPaperNames,
        NewScopus: getNewScopusPaperNames,
        NewScopus2: getNewScopus2PaperNames,
        NewScopusDetail: getNewScopusDetailPaperNames,
        CnkiOverSeaAuthor: getCnkiOverSeaAuthorPaperNames,
        CnkiOverSeaDetail: getCnkiOverSeaDetailPaperNames,
        onlinelibraryWiley: getonlinelibraryWileyPaperNames,
        ResearchGateDetail: getResearchGateDetailPaperNames,
        onlinelibraryWileyDetail: getonlinelibraryWileyDetailPaperNames,
        apsDetail: getapsDetailPaperNames,
        APAPsycnet: getAPAPsycnetPaperNames,
        APAPsycnetDetail: getAPAPsycnetDetailPaperNames,
        medWangFang: getmedWangFangPaperNames,
        medWangFangMirror: getmedWangFangMirrorPaperNames,
        medWangFangDetail: getmedWangFangDetailPaperNames,
        APAPsycnetmostcited: getAPAPsycnetmostcitedPaperNames,
        pubscholar: getpubscholarPaperNames,
        pubscholarDetail: getpubscholarDetailPaperNames,
        mdpi: getmdpiPaperNames,
        mdpiDetail: getmdpiDetailPaperNames,
        acs: getacsPaperNames,
        acsDetail: getacsDetailPaperNames,
        yiigle: getyiiglePaperNames,
        yiigle2: getyiigle2PaperNames,
        yiigleDetail: getyiigleDetailPaperNames,
        rsc: getrscPaperNames,
        rscDetail: getrscDetailPaperNames,
        spis: getspisPaperNames,
        spisDetail: getspisDetailPaperNames,
        spisJournal: getspisJournalPaperNames,
        heinonline: getheinonlinePaperNames,
        oldPubmed: getoldPubmedPaperNames,
        oldPubmedDetail: getoldPubmedDetailPaperNames,
        nature: getnaturePaperNames,
        natureDetail: getnatureDetailPaperNames,
        letpub: getletpubPaperNames,
        philpapers: getphilpapersPaperNames,
        philpapersDetail: getphilpapersDetailPaperNames,
        SpringerNew: getSpringerNewPaperNames,
        pubmedProSearch: getpubmedProSearchPaperNames,
        chkdx: getchkdxPaperNames,
        qxmd: getqxmdPaperNames,
        qxmdjournals: getqxmdjournalsPaperNames,
        lensscholar: getlensscholarPaperNames,
        journalfinderwiley: getjournalfinderwileyPaperNames,
        authorservicestaylorandfrancis: getauthorservicestaylorandfrancisPaperNames,
        citexsjournalQuery: getcitexsjournalQueryPaperNames,
        citexsjournalQuery2: getcitexsjournalQuery2PaperNames,
        citexsjournalQuery3: getcitexsjournalQuery3PaperNames,
        citexsjournalQuery4: getcitexsjournalQuery4PaperNames,
        citexsjournalQuery5: getcitexsjournalQuery5PaperNames,
        citexsjournalQuery6: getcitexsjournalQuery6PaperNames,
        amend: getamendPaperNames,
        yanxue: getyanxuePaperNames,
        medreading: getmedreadingPaperNames,
        fmrs: getfmrsPaperNames,
        ebsco: getebscoPaperNames,
        CnkiAISearch: getCnkiAISearchPaperNames,
        journalfinderspringer: getjournalfinderspringerPaperNames,
        epubs: getepubsPaperNames,
        epubsDetail: getepubsDetailPaperNames,
        sinomed: getsinomedPaperNames,
        sagepub: getsagepubPaperNames,
        biomedcentral: getbiomedcentralPaperNames,
        consensus: getconsensusPaperNames,
        ablesci: getablesciPaperNames,
        dbdata: getdbdataPaperNames,
        dbdataDetail: getdbdataDetailPaperNames,
        blyun: getblyunPaperNames,
        Springerjournal: getSpringerjournalPaperNames,
        frontiersinDetail: getfrontiersinDetailPaperNames,
        SemanticScholar: getSemanticScholarPaperNames,
        GoogleLabs: getGoogleLabsPaperNames,
        orcid: getorcidPaperNames,
        XMOL2: getXMOL2PaperNames,
        ACM: getACMPaperNames,
        kccnki: getkccnkiPaperNames
    }
;


let paperManagerHandlers = {
        CnkiDetail: addCnkiDetailPaperManager,
        CnkiOverSeaDetail: addCnkiOverSeaDetailPaperManager,
        SpringerDetail: addSpringerDetailPaperManager,
        IeeeDetail: addIeeeDetailPaperManager,
        WOSDetail: addWOSDetailPaperManager,
        AminerDetail: addAminerDetailPaperManager,
        PubmedDetail: addPubmedDetailPaperManager,
        ReadPaperDetail: addReadPaperDetailPaperManager,
        ScienceDirectDetail: addScienceDirectDetailPaperManager,
        YuntsgPubmedDetail: addYuntsgPubmedDetailPaperManager,
        YuntsgDetail: addYuntsgDetailPaperManager,
        Google: addGooglePaperManager,
        EmbaseDetail: addEmbaseDetailPaperManager,
        ScopusDetail: addScopusDetailPaperManager,
        XMOLDetail: addXMOLDetailPaperManager,
        WangfangDetail: addWangfangDetailPaperManager,
        CnkiSpace: addCnkiSpacePaperManager,
        SemanticDetail: addSemanticDetailPaperManager,
        Jstor: addJstorPaperManager,
        EiDetail: addEiDetailPaperManager,
        NssdDetail: addNssdDetailPaperManager,
        ProquestDetail: addProquestDetailPaperManager,
        CambridgeDetail: addCambridgeDetailPaperManager,
        OxfordDetail: addOxfordDetailPaperManager,
        CnkiScholarDetail: addCnkiScholarDetailPaperManager,
        APAPsycnetDetail: addAPAPsycnetDetailPaperManager,
        medWangFangDetail: addmedWangFangDetailPaperManager,
        onlinelibraryWileyDetail: addonlinelibraryWileyDetailPaperManager,
        pubscholarDetail: addpubscholarDetailPaperManager,
        mdpiDetail: addmdpiDetailPaperManager,
        acsDetail: addacsDetailPaperManager,
        yiigleDetail: addyiigleDetailPaperManager,
        spisDetail: addspisDetailPaperManager,
        philpapersDetail: addphilpapersDetailPaperManager
    }
;


let paperInformationHandlers = {
        CnkiDetail: getCnkiDetailPaperInformation,
        CnkiOverSeaDetail: getCnkiOverSeaDetailPaperInformation,
        SpringerDetail: getSpringerDetailPaperInformation,
        IeeeDetail: getIeeeDetailPaperInformation,
        WOSDetail: getWOSDetailPaperInformation,
        AminerDetail: getAminerDetailPaperInformation,
        PubmedDetail: getPubmedDetailPaperInformation,
        ReadPaperDetail: getReadPaperDetailPaperInformation,
        ScienceDirectDetail: getScienceDirectDetailPaperInformation,
        YuntsgPubmedDetail: getYuntsgPubmedDetailPaperInformation,
        YuntsgDetail: getYuntsgDetailPaperInformation,
        Google: getGooglePaperInformation,
        EmbaseDetail: getEmbaseDetailPaperInformation,
        ScopusDetail: getScopusDetailPaperInformation,
        XMOLDetail: getXMOLDetailPaperInformation,
        WangfangDetail: getWangfangDetailPaperInformation,
        CnkiSpace: getCnkiSpacePaperInformation,
        SemanticDetail: getSemanticDetailPaperInformation,
        Jstor: getJstorPaperInformation,
        EiDetail: getEiDetailPaperInformation,
        NssdDetail: getNssdDetailPaperInformation,
        ProquestDetail: getProquestDetailPaperInformation,
        CambridgeDetail: getCambridgeDetailPaperInformation,
        OxfordDetail: getOxfordDetailPaperInformation,
        CnkiScholarDetail: getCnkiScholarDetailPaperInformation,
        APAPsycnetDetail: getAPAPsycnetDetailPaperInformation,
        medWangFangDetail: getmedWangFangDetailPaperInformation,
        onlinelibraryWileyDetail: getonlinelibraryWileyDetailPaperInformation,
        pubscholarDetail: getpubscholarDetailPaperInformation,
        mdpiDetail: getmdpiDetailPaperInformation,
        acsDetail: getacsDetailPaperInformation,
        yiigleDetail: getyiigleDetailPaperInformation,
        spisDetail: getspisDetailPaperInformation,
        philpapersDetail: getphilpapersDetailPaperInformation
    }
;
...
let paperManagerWebsiteList = [ "CnkiDetail", "CnkiOverSeaDetail", "SpringerDetail", "IeeeDetail", "WOSDetail"
    ...
    ,  "SemanticDetail", "Jstor", "EiDetail", "NssdDetail", "ProquestDetail", "CambridgeDetail"
...
// 一个网站有多个名字，大约有50个网站
let showRankingWebsiteList = ["Baidu","BaiduDetail","BaiduOld",  "Aminer", "AminerDetail", "Dblp", "Ieee", "IeeeDetail",
    "Google", "GoogleCitations", "WOSDetail", "WOS", "WOSJCR","WOSJCRDetail","Pubmed", "PubmedDetail", "ReadPaper", "ReadPaperDetail",
    "ScienceDirect", "ScienceDirectDetail", "Springer","Springeropen", "SpringerDetail", "YuntsgDetail", "YuntsgPubmedDetail"
    ...
    , "ConnectedPapers", "ConnectedPapersDetail", "NewScopus","NewScopus2", "NewScopusDetail", "CnkiOverSeaAuthor", "CnkiOverSeaDetail",
...
"acs", "acsDetail", "yiigle","yiigle2","yiigleDetail", "rsc","rscDetail","spis","spisDetail","spisJournal","heinonline","oldPubmed","oldPubmedDetail",
    ...
    "journalfinderspringer","epubs","epubsDetail","sinomed","sagepub","biomedcentral","consensus","ablesci","dbdata","dbdataDetail","blyun","Springerjournal"
    ,"frontiersinDetail","SemanticScholar", "GoogleLabs", "orcid", "XMOL2","ACM","kccnki"
];
...
function changeNoTranslate(){
    // $("span.easyscholar-ranking").attr("translate", "no");
    // $("span.easyscholar-ranking").attr("data-translate", "no");
...
function getCurrentWebSite(url) {
    if (url.indexOf("xueshu.baidu.com/ndscholar/browse/detail?paperid") !== -1) {
        return "BaiduDetail";
        ...
        return "Springer";
    }else if (url.indexOf("www.springeropen.com/search?query") !== -1) {
        return "Springeropen";
    }else if (url.indexOf("//link.springer.com/journal/") !== -1) {
        return "Springerjournal";
    }else if (((url.indexOf("link.springer.com") !== -1) && (url.indexOf("/search?") !== -1) && url.indexOf('new-search=true') !== -1 )
    || ($(".u-container ol.u-list-reset > li.app-card-open").length !== 0 && $("#search-springerlink").length !== 0)) {
        return "SpringerNew";
        ...
        || (($("form.QuickSearch #article-quick-search").length !== 0) && $("a.publication-title-link").length !== 0)) {
    ...
    || $("#gs_bdy_ccl > #gs_res_ccl > #gs_res_ccl_mid").length !== 0 ) {
    ...
    } else if (url.indexOf("xueshu.baidu.com/ndscholar/browse/search") !== -1) {
        return "Baidu";
        ...
        return "XMOL";
    } else if ((url.indexOf("www.x-mol.com/paper") !== -1) && ($("div[class*='SearchResultLayout-module'] div[class*='SearchResultLayout-module'] div[class*='SearchPaperGridCard']").length !== 0)) {
        return "XMOLSquare";
        ...
        return "CnkiSpace";
    } else if ( ($("#articlelist > #remark").length !==0 && $("#pagescreenshot > #body > div > #searchlist").length !==0)   ||  url.indexOf("qikan.cqvip.com/Qikan/Search/") != -1) {
        return "Weipu";
    } else if ($("#pdf-details").length !== 0 && $(".top-detail-left").length !== 0 && $("#cqvip").length !== 0) {
        return "WeipuDetail";
    ...
    ||
        ($(".search-result > #search-result").length !== 0 && $(".search-results-wrapper div[data-widget-def='UX3SearchResults'] > .search-result").length !== 0)
    ) {
    ...
    } else if (url.indexOf("med.wanfangdata.com.cn/Paper/Search?q") !== -1
        || url === "https://med.wanfangdata.com.cn/Paper"
        || ($("#paper-content-wrap > .mod-results > #resultsList > .item > .item-content").length !== 0)
        || ($("#advancedSearch .mainContent .mod-list_of_literature ul.literature_list > .item").length !== 0)
    ){
        return "medWangFang";
        ...
        return "rscDetail";
    }else if (url.indexOf("pubs.acs.org/action/doSearch?") !== -1 || ($("#pb-page-content .issue-item .issue-item_metadata").length !== 0)){
        return "acs";
        ...
        return "yiigleDetail";
    }else if (url.indexOf("spis.hnlat.com/scholar/list") !== -1 || ($(".spis-search-box").length !== 0 && $(".spis-article-list-r > .data-box > .article").length !== 0)){
        return "spis";
    }else if (url.indexOf("spis.hnlat.com/scholar/detail/") !== -1 ){
        return "spisDetail";
    }else if (url.indexOf("spis.hnlat.com/action/journal/doSearch?") !== -1 || ($(".spis-search-box").length !== 0 && $(".app-content > .journal-list-container > .data-box > .journal ").length !== 0)){
        return "spisJournal";
    }else if ($(".control-group .controls .section_type_article_b .lucene_search_result_b").length !== 0){
        return "heinonline";
    }else if ((url.indexOf("pmc.ncbi.nlm.nih.gov/search") !== -1 && $(".pmc-nav-container").length !== 0) || ($(".header > .res_logo > .img_logo > a").text() === "PMC")){
        return "oldPubmed";
    }else if (url.indexOf("pmc.ncbi.nlm.nih.gov/articles") !== -1){
        return "oldPubmedDetail";
    }else if (url.indexOf("www.nature.com/search") !== -1 || ($("#search-keywords").length !== 0 && $("ul.app-article-list-row > li.app-article-list-row__item").length !== 0)){
        return "nature";
    }else if (($("article .c-article-header  h1.c-article-title").length !== 0 ) || url.indexOf("www.nature.com/articles/" ) !== -1){
        return "natureDetail";
    ...
    }else if (url.indexOf("chkdx.cnki.net/kns8") !== -1 || $(".result_wrap table.list_table > thead > tr > th ").length === 9  || $(".result_wrap table.list_table > thead > tr > th ").length === 8){
        return "chkdx";
        ...
        return "ebsco";
    }else if (url.indexOf("epubs.siam.org/action/doSearch?") !== -1){
        return "epubs";
    }else if (url.indexOf("epubs.siam.org/doi/") !== -1){
        return "epubsDetail";
    } else if (url.indexOf("www.sinomed.ac.cn/crossSearch.do?searchwordwm") !== -1 || $(".txt_left #result-items .recoreddiv .jg-labs").length !== 0) {
        return "sinomed";
    }else if (url.indexOf("journals.sagepub.com/action/doSearch?AllField") !== -1) {
        return "sagepub";
    }else if (url.indexOf("www.biomedcentral.com/search?query=") !== -1) {
        return "biomedcentral";
    }else if (url.indexOf("https://consensus.app/search/") !== -1) {
        return "consensus";
    }else if (url.indexOf("ablesci.com/journal/detail?id") !== -1) {
        return "ablesci";
    }else if (url.indexOf("dbdata.com/list/") !== -1) {
        return "dbdata";
    }else if (url.indexOf("dbdata.com/detail/") !== -1) {
        return "dbdataDetail";
    }else if (url.indexOf("blyun") !== -1 && $("#noscroll .HeaderTop ul li.Curtop").length !== 0) {
        return "blyun";
    }else if (url.indexOf("frontiersin.org/journals/") !== -1 && url.indexOf("/articles/") !== -1){
        return "frontiersinDetail";
    }else if (url.indexOf("frontiersin.org/search?query") !== -1){
        return "frontiersin";
    }else if (url.indexOf("www.semanticscholar.org/author") !== -1){
        return "SemanticScholar";
    }else if (url.indexOf("https://scholar.google.com/scholar_labs/") !== -1){
        return "GoogleLabs";
    }else if (url.indexOf("https://orcid.org/") !== -1 && url.indexOf("-") !== -1){
        return "orcid";
    } else if ((url.indexOf("www.x-mol.com/paper") !== -1) && ($("div[class*='SearchResultLayout-module'] div[class*='SearchResultLayout-module'] div[class*='SearchPaperListCard']").length !== 0)) {
        return "XMOL2";
    }else if (url.indexOf("dl.acm.org/action/doSearch") !== -1)  {
        return "ACM";
    }else if (url.indexOf("kc.cnki.net/search") !== -1
    || (url.indexOf("kc") !== -1) && $(".result-main-list > .main-list__content > .result-list ").length !== 0 && $(".kc-logo ").length !== 0
    )  {
        return "kccnki";
    } else if ($("div[class*='DocumentSearchResultsPage_documentSearchResultsPage'] .document-results-list-namespace .document-results-list-layout").length !== 0) {
            return "NewScopus2";
    }
...
function addPapersRank(papersName, data) {
    ...
    if (Object.keys(data["publicationName"]).length > 0 && !isPublicationEmpty(data["publicationName"])) {
        let time0 = new Date();
        console.log("发起请求" + time0.getTime());
        chrome.runtime.sendMessage({
            ...
            let time1 = new Date();
            console.log("获得结果" + time1.getTime() + "用时" + (time1 - time0));
            ...
            for (let i = 0; i < papersRank.length; i++) {
                for (let key in papersRank[i]) {
                    if (key === "tempID" || key === "sciUpSmall" || key === "xrSmall") {
                        continue;
                    }
                    if (key === "sciUp" && ("sciUpSmall" in papersRank[i])) {
                        dosciUpPaperRank(papersRank[i][key], papersRank[i], papersRank[i]["sciUpSmall"]);
                    } else if (key === "xr" && ("xrSmall" in papersRank[i])) {
                        doxrPaperRank(papersRank[i][key], papersRank[i], papersRank[i]["xrSmall"]);
                    } else {
                        let targetFunc = paperRankHandlers[key];
                        if (typeof targetFunc === 'function') {
                            targetFunc(papersRank[i][key], papersRank[i]);
                        }
                    }
                }
                hideSpan();
            ...
            let time2 = new Date();
            console.log("渲染完成" + time2.getTime() + "用时" + (time2 - time1));
            ...
            changeNoTranslate();
            let time3 = new Date();
            console.log("渲染自定义数据集完成" + time3.getTime() + "用时" + (time3 - time2));
        });
    }
};
...
function mainShowRanking(optionCheckd) {
    ...
    if (website != null && $.inArray(website, showRankingWebsiteList) != -1) {
        let targetFunc = paperNameHandlers[website];
        if (typeof targetFunc === 'function') {
            targetFunc();
            hideSpan();
            changeColor();
...
function getBaiduPaperNames() {
    ...
    allPaperDiv.each(function () {
        ...
        if (flag1.length === 0) {
            hrefName = singlePaperDiv.find(".paper-info  a[href*='data/journal']:first").text().replaceAll("《", "").replaceAll("》", "").toUpperCase();
            if(hrefName === ""){
                hrefName = singlePaperDiv.find(".paper-info  span:contains('《'):contains('》'):first").text().replaceAll("《", "").replaceAll("》", "").toUpperCase();
            }
            console.log(hrefName)
            let title = singlePaperDiv.find("h3.paper-title");
            if (title.length === 0) {
                return true;
            }
...
function getBaiduOldPaperNames() {
...
function getBaiduDetailPaperNames() {
    ...
    if ($(".ant-spin-container .info-wrap span.easyScholarPaperFlag").length === 0) {

        let paperID = Math.floor(Math.random() * 100000);
        let hrefName = $(".info-wrap .tips a:first").text().toUpperCase();
        console.log(hrefName)
        $(".ant-spin-container .info-wrap .tips:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
        papersName[paperID] = hrefName;
    }

    let allPaperDiv = $(".list-wrap-item");
    ...
    allPaperDiv.each(function () {
        ...
        if (flag1.length === 0) {
            hrefName = singlePaperDiv.find(".message .journal").text();
            if (hrefName !== undefined) {
                hrefName = hrefName.replace("《", "").replace("》", "").toUpperCase();
                hrefName = hrefName.replaceAll("-", "");
                console.log(hrefName)
            }

            let title = singlePaperDiv.find("a.title");
            if (title.length === 0) {
                return true;
            }
            title.after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
...
function getGoogleLabsPaperNames() {
    let data = {};
...
function extractJournalNames(text) {
    // 正则表达式模式：匹配期刊名称
    let journalRegex = /(,\s*|\s+)\d.*$/g;
    text = text.replace(journalRegex, '')
    return text;
}
    ...
    allPaperDiv.each(function () {
        ...
        if (flag1.length == 0) {
            ...
            if (title && /.*(?=,\s\d{4})/.test(title)) {
                ...
                title = extractJournalNames(title);
                console.log(title)
...
function getWOSPaperNames() {
    ...
    allPaperDiv.each(function () {
        ...
        let flag1 = singlePaperDiv.find("span.easyScholarPaperFlag");
        // if (flag1.length === 0) {
        //     let title = singlePaperDiv.find(".jcr-sidenav-content .source-title-display a:first");
        //     console.log(title)
        ...
        if (flag1.length === 0) {
            let title = singlePaperDiv.find("span[lang='en']:first");
            ...
            if (name.length != 0) {
                ...
                let source2 = singlePaperDiv.find("a[lang='en']:first");
            ...
            let source_cn = singlePaperDiv.find("span[lang='zh-cn']:first");
            let name_cn = source_cn.text().trim().replaceAll("arrow_drop_down","");
            if (name_cn.length != 0) {
                papersName[paperID] = name_cn;
            } else {
                let source_cn2 = singlePaperDiv.find("a[lang='zh-cn']:first");
...
function getWOSSelectPaperNames() {
    ...
    let papersName = {};
    let allPaperDiv = $("app-journal-search-results > .ng-star-inserted > .ng-star-inserted");
    ...
    allPaperDiv.each(function () {
        ...
        if (flag1.length === 0) {
            let publication = singlePaperDiv.find("mat-card-title.mat-mdc-card-title").text().replaceAll("\n", "").trim();
            singlePaperDiv.find("mat-card-title.mat-mdc-card-title").append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'))
...
function getNewScopus2PaperNames() {

    let data = {};

    let papersName = {};
    let allPaperDiv = $("div[data-component='document-source']");
    console.log(allPaperDiv)
    allPaperDiv.each(function () {

        let hrefName;
        let paperID = Math.floor(Math.random() * 100000);
        let singlePaperDiv = $(this).parents("tr[class^='TableItems_resultsRow']");
        let flag1 = singlePaperDiv.find("span.easyScholarPaperFlag");
...
function getScopusAuthorPaperNames() {
    ...
    allPaperDiv.each(function () {
        ...
        if (flag1.length === 0) {
            ...
            title.after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
            // hrefName = singlePaperDiv.find("a[href*='/sourceid/']").text().trim();
            hrefName = singlePaperDiv.find("a[role='button']:first").text().trim();
            hrefName = hrefName.toLowerCase().replace("open source preview", "")
            // hrefName = singlePaperDiv.find("span a:first").text().trim();
            papersName[paperID] = hrefName.toUpperCase();
        }
    });
...
function getScienceDirectDetailPaperNames() {
    ...
    if ($("span.easyScholarPaperFlag").length === 0) {
        ...
        $("#screen-reader-main-title").append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));

        let hrefName = $("article .publication-title-link")?.text()?.toUpperCase();
        if(hrefName === undefined || hrefName === ""){
            hrefName = $("h2[data-aa-region='publication-title']:first")?.text()?.toUpperCase();
        }
        if (hrefName !== undefined) {
            papersName[paperID] = hrefName;
        }
    ...
    let allPaperDiv6 = $(".bibliography-sec > ol.references > li");

    allPaperDiv6.each(function () {
        let hrefName;
        let paperID = Math.floor(Math.random() * 100000);
        ...
        if (flag1.length === 0) {
            let title = singlePaperDiv.find("span.reference .host:first");
            title.after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
            hrefName = singlePaperDiv.find("span.reference .host:first")?.text()?.split(",")[0]?.replaceAll("\n", "")?.replaceAll(".", "")?.toUpperCase().trim();
            if (hrefName !== undefined) {
                papersName[paperID] = hrefName.toUpperCase();
            }
        }
    ...
    let allPaperDiv7 = $("ul > li.bib-reference");
    allPaperDiv7.each(function () {
        let hrefName;
        let paperID = Math.floor(Math.random() * 100000);
        ...
        if (flag1.length === 0) {
            let title = singlePaperDiv.find("span .series .title:first");
            title.after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
            hrefName = singlePaperDiv.find("span .series .title:first")?.text();
            if (hrefName !== undefined) {
                papersName[paperID] = hrefName.toUpperCase();
            }
        }
...
function getSpringerPaperNames() {
    ...
    let papersName = {};
    let allPaperDiv = $("ol.u-list-reset > li");
    allPaperDiv.each(function () {
        ...
        if (flag1.length === 0) {
            let hrefName = singlePaperDiv.find(".app-author-list a:first").text().trim();
            let node = singlePaperDiv.find("h3:first");
            if (node.length === 0) {
                return true;
            }
            node.append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
...
function getSpringeropenPaperNames() {

    let data = {};

    let papersName = {};
    let allPaperDiv = $("ol.c-listing > li.c-listing__item > article");
    ...
    allPaperDiv.each(function () {
        ...
        if (flag1.length === 0) {
            let hrefName = singlePaperDiv.find("em[data-test='journal-title']").text().trim();
    ...
    data["website"] = "Springeropen";
    addPapersRank(papersName, data)
};


function getSpringerjournalPaperNames() {
    ...
    if ($("span.easyScholarPaperFlag").length === 0) {
        let node = $(".app-journal-masthead__title-link:first");
        if (node.length === 0) {
            return null;
        }
        node.after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));

        let hrefName = $(".app-journal-masthead__title-link:first").text().trim().toUpperCase();
        if (hrefName) {
            papersName[paperID] = hrefName;
        }
    }
...
function getkccnkiPaperNames() {
    let data = {};

    let papersName = {};
    let allPaperDiv = $("td[data-col-key='LY']");
    ...
    allPaperDiv.each(function () {
        ...
        let title;
        let node;
        if (flag1.length === 0 && singlePaperDiv.parent().find("a:first").length !== 0) {
            if (singlePaperDiv.find("a").length !== 0) {
                title = singlePaperDiv.find("a:first").text();
                if (title.length === 0) {
                    return true;
            ...
            singlePaperDiv.parent().find("a:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
        }
    });
        ...
        if (single.find("span.easyScholarPaperFlag").length === 0) {
            ...
            if(flag === 1){
                if (/(?=\S\.)\S*$/.test(singleText)) {
                    ...
                    publication = publication.replaceAll(/,\d{4}.*/g,"");
                    if (publication !== "") {
                        papersName[paperID] = publication.toUpperCase();
                    }
                }
            }else{
                if (/\s*([A-Za-z ]+)\.\s*\d/g.test(singleText)) {
                    let publication = singleText.match(/\s*([A-Za-z ]+)\.\s*\d/g)[0];
                    publication = publication.replaceAll(/\d*$/g,"");
                    publication = publication.replaceAll(/.$/g,"");
                    if (publication !== "") {
                        papersName[paperID] = publication.toUpperCase();
                    }
                }
...
function getXMOL2PaperNames() {

    let data = {};

    let papersName = {};
    let allPaperDiv = $("div[class*='SearchResultLayout-module'] div[class*='SearchResultLayout-module'] div[class*='cardBody']");
    ...
    allPaperDiv.each(function () {
        ...
        if (flag1.length === 0) {
            ...
            title = singlePaperDiv.find("span[class*='journalLink']").text().trim();

            node = singlePaperDiv.find("h3:first");
            if (node.length === 0) {
                return true;
            }
            node.append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
...
function getXMOLSquarePaperNames() {
    ...
    let papersName = {};
    let allPaperDiv = $("div[class*='SearchResultLayout-module'] div[class*='SearchResultLayout-module'] div[class*='SearchPaperGridCard']");
    ...
    allPaperDiv.each(function () {
        ...
        if (flag1.length === 0) {
            ...
            title = singlePaperDiv.find("span[class*='gridJournalName']:first").text().trim();

            node = singlePaperDiv.find("h3:first");
            if (node.length === 0) {
                return true;
            }
            node.after($('<div style="width:100%; max-width:350px; word-wrap:break-word; white-space:normal;"><span class="easyScholarPaperFlag" paperID="' + paperID + '"></span></div>'));
...
function getJournalFinderPaperNames() {
    let papersName = {};
    let data = {};
    let all = $("div[data-aa-region*='jf-journal-card']");

    all.each(function () {
        let singleDiv = $(this);
        let paperID = Math.floor(Math.random() * 100000);
        if (singleDiv.find("span.easyScholarPaperFlag").length === 0 && singleDiv.find("h2").length !== 0) {
...
function getWeipuPaperNames() {
    let papersName = {};
    let data = {};
    let all = $(".simple-list > dl");


    all.each(function () {
        let single = $(this);
        let paperID = Math.floor(Math.random() * 100000);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("dt:first").length !== 0) {
            let publication = single.find(".from > a").attr("title");
            single.find("dt:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
            papersName[paperID] = publication.toUpperCase();
        }
    });
...
function getWeipuDetailPaperNames() {
    ...
    let paperID = Math.floor(Math.random() * 100000);
    if ($("span.easyScholarPaperFlag").length == 0) {
        let publication = $(".sourceHover:first").text().replaceAll("《","").replaceAll("》","");
        $("span[slot='collectObject']:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" > </span>'));
        papersName[paperID] = publication.toUpperCase();
    }
...
function getSemanticScholarPaperNames() {

    let papersName = {};
    let data = {};
    let all = $("div.result-page > .author-page-details__paper-row");
    ...
    all.each(function () {
        ...
        if(single.find(".cl-paper__bulleted-row__item > a >span").length !== 0){
            ...
            publication = $(".formatted-citation--style-bibtex").text().match(/(?=journal={).*(?=},)/);
            if(publication == null){
                publication = $(".formatted-citation--style-bibtex").text().match(/(?=booktitle={).*(?=},)/);
            }
            $("#app > div.cl-overlay.cl-overlay__content-position--center > div > div > div.cl-modal__close-section > button").click();
            if (publication == null) {
                return true
            } else {
                publication = publication[0].replace("journal={", "").replace("booktitle={", "");
            }
        }
        papersName[paperID] = publication.toUpperCase();
...
function getDuxiu2PaperNames() {
    ...
    all.each(function () {
        ...
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("span").closest("div").find("a:first").length !== 0) {
...
function getmedWangFangPaperNames() {
    ...
    let all2 = $("ul.literature_list > .item");

    all2.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".title_and_share").length !== 0 ) {
            let text = single.find(".publication > a:first").text().trim();
            let publication = "";
            if(text.indexOf("《") !== -1 && text.indexOf("》") !== -1){
                publication = text.split("《")[1].split("》")[0];
            }

            single.find(".title_and_share:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            papersName[paperID] = publication.toUpperCase();
        }
    });
...
function getmedWangFangDetailPaperNames() {
    ...
    if ($("span.easyScholarPaperFlag").length === 0) {
        $(".content > .headline").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
        let publication = $("#journals .title:first").text();
...
function getpubscholarDetailPaperNames() {
    ...
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".RecommendationItem__title").length !== 0) {
...
function getrscDetailPaperNames() {
    ...
    if ($(".article-control span.easyScholarPaperFlag").length === 0) {
    ...
    let all = $(".ref-list > ol > li");
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0) {
            let publication = single.find("em:first").text().trim();
...
function getspisPaperNames() {
    ...
    let all = $(".spis-article-list-r > .data-box > .article");

    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".d-a").length !== 0) {
            let publication = single.find(".d-a").text().trim();

            if(/(?=-).*(,\s)/.test(publication)){
                publication = publication.match(/(?=-).*(,\s)/)[0].replaceAll("- ","").replaceAll(",","").trim();
                single.find(".d-a").append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
                papersName[paperID] = publication.toUpperCase();
            }
        }
    });
...
function getspisDetailPaperNames() {
    ...
    if ($("span.easyScholarPaperFlag").length === 0 && $("a.default-text:first").length !== 0) {
        $("a.default-text:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
        let publication = $("a.default-text:first").text();
...
function getspisJournalPaperNames() {
    ...
    let all = $(".journal-list-container > .data-box > .journal ");

    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && $(".field").length !== 0)  {
            let publication = single.find(".header > a:first").text().trim();

            single.find(".field").append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            papersName[paperID] = publication.toUpperCase();
        }
    });
...
function getoldPubmedPaperNames() {
    ...
    let all = $("ul.usa-card-group >  li.article");

    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".docsum-title:first").length !== 0) {
            single.find(".docsum-title:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));

            let publication = single.find("ul > li:eq(1) span").text().trim();
...
function getoldPubmedDetailPaperNames() {
    ...
    if ($("span.easyScholarPaperFlag").length === 0 && $("h1").length > 0) {
        $("h1:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
        let publication = $("button[aria-controls='journal_context_menu']").text();
        papersName[paperID] = publication.toUpperCase();
    }
...
function getepubsDetailPaperNames() {
    let papersName = {};
    let data = {};
    ...
    if ($("span.easyScholarPaperFlag").length === 0) {
        $("h1:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
        let publication = $("a.article__tocHeading:eq(1)").text();
        papersName[paperID] = publication.toUpperCase();
    }
...
function getnatureDetailPaperNames() {
    ...
    if ($("span.easyScholarPaperFlag").length === 0) {
        $("h1:first").append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
...
function getSpringerNewPaperNames() {
    ...
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("h3:first").length !== 0) {
            single.find("h3:first").append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
    ...
    all2.each(function () {
        ...
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("h3:first").length !== 0) {
            single.find("h3:first").append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = single.find(".app-author-list > a.u-color-inherit").text().trim();
            papersName[paperID] = publication.toUpperCase();
        }
    });
...
function getjournalfinderwileyPaperNames() {
    ...
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("a > .journalMetaData-mainTitle").length !== 0 ) {
...
function getjournalfinderspringerPaperNames() {
    ...
    let all = $(".u-list-reset > li[data-test^='journal-id-']");

    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("h3").length !== 0 ) {
            single.find('h2:first').append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = single.find('h2:first').text();
            papersName[paperID] = publication.toUpperCase().trim();
...
function getauthorservicestaylorandfrancisPaperNames() {
    ...
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("a.journalfinder__item--title").length !== 0 ) {
...
function getamendPaperNames() {
    ...
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("h4").length !== 0) {
...
function getyanxuePaperNames() {
    ...
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".title-con").length !== 0) {
...
function getmedreadingPaperNames() {
    ...
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".journal-name").length !== 0) {
...
function getfmrsPaperNames() {
    ...
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".content-container").length !== 0) {
...
function getepubsPaperNames() {
    ...
    all.each(function () {
        ...
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".content-container").length !== 0) {
            single.find(".hlFld-Title").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = single.find("a.meta__serial").text()
            papersName[paperID] = publication.toUpperCase().trim();
        }
    });
...
function getsagepubPaperNames() {
    ...
    let all = $(".items-results > .issue-item");


    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find(".issue-item__journal").length !== 0) {
            single.find(".issue-item__journal").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = single.find(".issue-item__journal").text()
            papersName[paperID] = publication.toUpperCase().trim();
        }
    });
    ...
    data["website"] = "sagepub";
    addPapersRank(papersName, data);
};


function getbiomedcentralPaperNames() {
    let papersName = {};
    let data = {};

    let all = $(".c-listing > .c-listing__item");


    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("em[data-test='journal-title']").length !== 0) {
            single.find("em[data-test='journal-title']").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = single.find("em[data-test='journal-title']").text()
            papersName[paperID] = publication.toUpperCase().trim();
        }
    });
    ...
    data["website"] = "biomedcentral";
    addPapersRank(papersName, data);
};

function getconsensusPaperNames() {
    let papersName = {};
    let data = {};

    let all = $("div[data-testid='search-results-list'] > div >div");


    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("section:first").length !== 0) {
            single.find("section:first").before($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = single.find(".italic:first").text()
            console.log(publication)
            papersName[paperID] = publication.toUpperCase().trim();
        }
    });
    ...
    data["website"] = "consensus";
    addPapersRank(papersName, data);
};



function getsinomedPaperNames() {
    let papersName = {};
    let data = {};
    ...
    let all = $(".recoreddiv .right-wztxt");
    all.each(function () {
        let single = $(this);
        let publication = "";
        if(single.find("span:contains('出处')").next()[0].nodeName.toLowerCase() === 'strong'){
            publication = single.find("span:contains('出处')").next("strong").find("a:first").text();
        }else{
            publication = single.find("span:contains('出处')").next("a:first").text();
        }
        temp_storage += publication;
    });
    ...
    all.each(function () {
        ...
        let single = $(this);
        if (single.find("span.easyScholarPaperFlag").length === 0 && single.find("h2").length !== 0) {
    ...
    data["website"] = "sinomed";
    addPapersRank(papersName, data);
};


function getdbdataPaperNames() {
    let papersName = {};
    let data = {};


    let all = $(".card-list > .card");

    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);

        let single = $(this);
        if(single.find(".hight-light-jn:first") && single.find("span.easyScholarPaperFlag").length === 0){
            single.find(".title:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = "";
            publication = single.find(".hight-light-jn:first").text();
            papersName[paperID] = publication.toUpperCase().trim();
        }
    });
...
function getdbdataDetailPaperNames() {
    let papersName = {};
    let data = {};

    if($(".baseinfo > span.easyScholarPaperFlag").length === 0){
        let paperID = Math.floor(Math.random() * 100000);
        let publication = "";
        publication = $(".baseinfo .hight-light-jn:first").text();
        papersName[paperID] = publication.toUpperCase().trim();
        $(".baseinfo .title:first ").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
    }
    ...
    data["website"] = "dbdataDetail";
    addPapersRank(papersName, data);
};

function getfrontiersinPaperNames() {
    let papersName = {};
    let data = {};

    let all = $("ul.articles > li");
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);

        let single = $(this);
        if(single.find(".data-bottom > .source span") && single.find("span.easyScholarPaperFlag").length === 0){
            single.find(".title:first").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = "";
            publication = single.find(".data-bottom > .source span:first").text();
            papersName[paperID] = publication.toUpperCase().trim();
        }
    });
    ...
    data["website"] = "frontiersin";
    addPapersRank(papersName, data);
};

function getfrontiersinDetailPaperNames() {
    let papersName = {};
    let data = {};

    if($(".JournalAbstract > span.easyScholarPaperFlag").length === 0){
        let paperID = Math.floor(Math.random() * 100000);
        let publication = "";
        publication = $(".Ibar__journal--main .Ibar__journalName:first").text();
        papersName[paperID] = publication.toUpperCase().trim();
        $(".JournalAbstract").append($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
    }
    ...
    data["website"] = "frontiersinDetail";
    addPapersRank(papersName, data);
};


function getblyunPaperNames() {
    let papersName = {};
    let data = {};

    let all = $(".centerMain > .Resultcon > div");
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);

        let single = $(this);
        if(single.find(".Bookinfo:first").length !== 0 && single.find("span.easyScholarPaperFlag").length === 0){

            single.find(".Bookinfo:first").before($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = "";
            single.find(".Bookinfo").each(function() {
...
function getorcidPaperNames() {
    let papersName = {};
    let data = {};

    let all = $("#cy-works app-work-stack");
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);

        let single = $(this);
        if(single.find(".data-content > div > div.general-data:first") && single.find("span.easyScholarPaperFlag").length === 0){
            single.find(".data-content > div > div.general-data:first").before($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = "";
            publication = single.find(".data-content > div > div.general-data:first").text();
            papersName[paperID] = publication.toUpperCase().trim();
        }
    });
...
function getACMPaperNames() {
    let papersName = {};
    let data = {};

    let all = $(".doSearch > ul.items-results > li.issue-item-container");
    all.each(function () {
        let paperID = Math.floor(Math.random() * 100000);

        let single = $(this);
        if(single.find(".issue-item__detail").length !== 0 && single.find("span.easyScholarPaperFlag").length === 0){
            single.find(".issue-item__detail").after($('<span class ="easyScholarPaperFlag" paperID="' + paperID + '" ></span>'));
            let publication = "";
            publication = single.find(".issue-item__detail > a:first").attr("title")
            console.log(publication)
...
function getgoogleScholarlabsPaperNames() {
...
function doswufePaperRank(swufeRank, paper) {
    ...
    } else if (rank == "SWUFE A1") {
        rankColour = 'easyscholar-3';
    } else if (rank == "SWUFE A2") {
...
function doxrTopPaperRank(xrTop, paper) {
    ...
    span.addClass(rankColour);
    span.addClass("easyscholar-ranking");
    span.text("新锐分区 " + xrTop);
    span.attr("title", titlexrTop);
    $("span[paperid=" + paper.tempID + "]:first").after(span);
    docnkiOverSeaPaperRank(span, paper);
};

function doxrPaperRank(xr, paper, xrSmall) {

    let rank = (xr == null) ? "" : ("新锐分区 " + xr);
    let rankColour = "";
    ...
    let span = $('<span></span>');
    if (xrSmall !== undefined) {
        span.attr("title", "新锐小类分区：“" + xrSmall + '”。' + titlexr);
    } else {
        span.attr("title", titlexr);
    }
    span.addClass(rankColour);
    span.addClass("easyscholar-ranking");
    span.text(rank);
...
function doesciPaperRank(esci, paper) {

    let rank = (esci == null) ? "" : ("ESCI " + esci);
    let rankColour = "";

    if (rank === "ESCI Q1") {
        rankColour = 'easyscholar-1';
    } else if (rank === "ESCI Q2") {
        rankColour = 'easyscholar-2';
    } else if (rank === "ESCI Q3") {
        rankColour = 'easyscholar-3';
    } else if (rank === "ESCI Q4") {
        rankColour = 'easyscholar-4';
    }else {
        rankColour = 'easyscholar-5';
    }
    ...
    span.addClass("easyscholar-ranking");
    span.text(rank);
    span.attr("title", titleesci);
    $("span[paperid=" + paper.tempID + "]:first").after(span);
    docnkiOverSeaPaperRank(span, paper);
};

function doxrWarnPaperRank(xrWarn, paper) {
    ...
    if(rank === "1"){
        ...
        span.text("新锐分区预警 " + rank);
    }
    span.attr("title", titlexrWarn);
    span.prepend(svg)
...
function paperManagerStart() {
    ...
    if (webSiteName != null
        ...
        let targetFunc = paperManagerHandlers[webSiteName];
        if (typeof targetFunc === 'function') {
            targetFunc();
        }
    }
...
function addWOSDetailPaperManager() {
    let clock = setInterval(function () {
        if ($("#FullRecSnRecListtop").length != 0 && $(".easyScholar_paper_collect").length == 0) {
            ...
            let WOSpaper = $('<button _ngcontent-ng-c543301715="" mat-stroked-button="" color="primary" class="easyScholar_paper_collect  margin-right-10--reversible full-record-breadcrumbs-styles mdc-button mdc-button--outlined mat-mdc-outlined-button mat-primary mat-mdc-button-base " aria-label="" cdk-describedby-host="ng-1"><!----><span class="mdc-button__label">easyScholar文献收藏<!----><!----></span></button>');
...
function insertPaper(clickBox) {
    ...
    let paperInfo;
    if (webSiteName != null) {
        let targetFunc = paperInformationHandlers[webSiteName];
        if (typeof targetFunc === 'function') {
            paperInfo = targetFunc(clickBox);
        }
    }
...
function getWOSDetailPaperInformation() {
    ...
    paperHref = paperHref.replaceAll("View Journal Impact", "")
...
function getmedWangFangDetailPaperInformation() {
    ...
    let paperFrom = "万方医学网";
    let paperHref = $("#journals .title:first").text();
    if(paperHref !== ""){
...
function addDoi() {
    ...
    //先查找网页中所有符合条件的DOI
    let allMatchText = $("html").text().match(/(10\.\d{4,9}\/[-._;():0-9a-zA-Z]+)/g);
    ...
    if ((((url.indexOf("scholar.google") != -1) || (url.indexOf("dailyheadlines.cc") != -1)
            || (url.indexOf("panda321.com") != -1) || (url.indexOf("scholar.ustc.cf") != -1)
            || (url.indexOf(".lanfanshu.cn") != -1))
        && (url.indexOf("/scholar?") != -1)
        || $("#gs_ab_btns > a.gs_btnL.gs_in_ib.gs_nph.gs_nta > span.gs_lbl").length !== 0
    ...
    if (allA.length < 400) {
        allA.each(function () {
            ...
            if(/(10\.\d{4,9}\/[-._;():0-9a-zA-Z]+)/g.test(singleHref)){
                let DOI = singleHref.match(/(10\.\d{4,9}\/[-._;():0-9a-zA-Z]+)/g)[0];

                if( single.parent().find("a.easyScholarDOI").length !== 0 && single.parent().find("a.easyScholarDOI")[0].getAttribute("href").indexOf(DOI) == -1 ){
                    single.parent().find("a.easyScholarDOI").remove();
                    console.log("移除")
                }
                // 对a中的href判断，如果/(10\.\d{4,9}\/[-._;():0-9a-zA-Z]+)/g.test()  满足
                if ((!googleFlag && single.parent().find("a.easyScholarDOI").length === 0) || (googleFlag && single.parent().find("a.easyScholarDOI").length === 0  && single.parent().parent().find("a.easyScholarDOI").length === 0 )) {
                    ...
                    singleDoi.attr("href", href);
                    if(googleFlag && single.parent().is("h3")){
                        single.parent().after(singleDoi);
                    }else{
...
function listenPubmed() {
    $("div.easyScholar-choice-grouop ul > li > input").unbind('click').bind('click', function () {
        ...
        infoNotice("您已经成功设置pubmed筛选条件。筛选功能不会补全文章，可能会隐藏全部文章；若不需要此功能，恢复原始状态（8个分区选中，影响因子清空）即可", "info",6000, true, true);
        listenPubmedHide();
    });
...
$(function () {
    chrome.storage.local.get({
        ...
        if (publicationRankIntro !== "" && isRankTitle === "RankTitleOpen") {
            ...
            titlexr = publicationRankIntro.titlexr;
            titlexrTop = publicationRankIntro.titlexrTop;
            titlexrWarn = publicationRankIntro.titlexrWarn;
            titleesci = publicationRankIntro.titleesci;
        }
