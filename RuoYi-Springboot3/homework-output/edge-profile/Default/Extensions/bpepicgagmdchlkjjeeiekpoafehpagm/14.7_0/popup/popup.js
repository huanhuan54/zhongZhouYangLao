...
$(function () {
    ...
    fetch("https://www.easyscholar.cc/extension/getRank9")
        .then(res => res.json())
        .then(res => {
            ...
            let showPriceInSafari = res.data.showPriceInSafari;
            let safari = res.data.safari;

            if(safari && !showPriceInSafari){
                $(".foot").hide();
                $("#quickIn").hide();
                $(".enter").hide();
                if(user == null){
